"""colin_weintraub_25264 URL Configuration
...
admin.site.site_header = "Colin Weintraub"
admin.site.site_title = "Colin Weintraub Admin Portal"
admin.site.index_title = "Colin Weintraub Admin"

# swagger
api_info = openapi.Info(
    title="Colin Weintraub API",
    default_version="v1",
    description="API documentation for Colin Weintraub App",
)
